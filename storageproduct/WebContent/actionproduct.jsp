	...
	<div class="popup-box" id="popup-box-1">
		...
		<div class="top">
			...
			<form class="add" action="ProductController" method="post">
				...
				<input placeholder="Название" type="text" name="prtitle" /> <input
					placeholder="Цена" type="text" name="prprice" /> <input
					placeholder="Количество" type="text" name="prnumber" /> <input
					placeholder="Картинка" type="text" name="primg" /> <input
					placeholder="Категория" type="text" name="pridcat" />
